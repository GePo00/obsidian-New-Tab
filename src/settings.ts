...
export class HomeTabSettingTab extends PluginSettingTab{
    ...
    display(): void{
        ...
        .setName('Replace new tabs with New tab')
        ...
        new Setting(containerEl)
        .setName('Open new New tab on Obsidian start')
        .setDesc('If a New-tab is already open it\'ll focus it instead of opening a new one.')
        .addToggle(toggle => toggle
        ...
        if(this.plugin.settings.newTabOnStart){
            new Setting(containerEl)
                ...
                .setDesc('Enable this to close all the tabs and leave only one New tab on Obsidian opening.')
                .addToggle(toggle => toggle
